...
export class Hero {
  ...
  blogData = {
    header: {
      ...
      name: 'ចំណេះដឹង និងប្លុកបច្ចេកវិទ្យាអគ្គិសនី',
    ...
    articles: [
      {
        ...
        category: 'Technology',
        date: 'Feb 14, 2026',
        name: 'កង្ហារបូមខ្យល់ឧស្សាហកម្ម (Industrial Exhaust Fan)',
      ...
      },
      {
        ...
        category: 'Technology',
        date: 'Feb 14, 2026',
        name: 'ប្រអប់បញ្ជាម៉ូទ័រ (Magnetic Starter)',
      ...
      },
      {
        ...
        category: 'Technology',
        date: 'Feb 14, 2026',
        name: 'អាមពែម៉ែត្រគាប (Multi-functional Clamp Meter)',
